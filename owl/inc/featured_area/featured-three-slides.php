<div class="featured-area">
	...
	<div id="owlslider-featured-three-slider" class="owl-carousel">
		...
		<?php if ($feat_query->have_posts()) : while ($feat_query->have_posts()) : $feat_query->the_post(); ?>
			<div class="item">
				<a href="<?php echo get_permalink() ?>" class="slider-image-effect <?php echo esc_attr($slider_border); ?>"><?php the_post_thumbnail('winvader-three-slides-thumb'); ?></a>
